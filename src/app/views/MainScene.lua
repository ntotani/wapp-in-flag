...
local DOTS = {
    ...
    {name = "nonowa", vel = 800, gra = 980, res = 2.0, face = "(のワの)", dead = "(のワ...:.;::.."},
    ...
    {name = "foon",   vel = 800, gra = 980, res = 0.1, face = "(´_ゝ`)", dead = "(´_ゝ...:.;::.."},
    ...
    {name = "manda",  vel = 800, gra = 980, res = 0.2, face = "( ⌒,_ゝ⌒)", dead = "( ⌒,_ゝ...:.;::.."},
